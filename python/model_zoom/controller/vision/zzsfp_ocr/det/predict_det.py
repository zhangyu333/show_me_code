...
import logging
from controller.vision.zzsfp_ocr.det.preprocess import preprocess_op
from controller.vision.zzsfp_ocr.det.postprocess import DBPostProcess
...
class TextDetector(object):
    def __init__(self, box_thresh=0.6, unclip_ratio=1.6, det_model_path=None, ort_providers=None):
        ...
        sess = ort.InferenceSession(Util.app_path() + f"/models/zzsfp/{model_file}", so, providers=ort_providers)
