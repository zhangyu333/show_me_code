from controller.voice.psp_tts.benepar import parse_chart
from controller.voice.psp_tts import treebanks
from controller.voice.psp_tts import seq_with_label
...
def init_model():
    model_path = Util.app_path() + '/models/tts/pretrained_SpanPSP_Databaker.pt'
    parser = parse_chart.ChartParser.from_trained(model_path)
    return parser


def run_auto_labels(parser, line):
    output_dir_yl1 = Util.app_path() + '/cache/temp1.txt'
    output_dir_yl = Util.app_path() + '/cache/temp.txt'
