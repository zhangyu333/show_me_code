...
from controller.vision.zzsfp_ocr.cls.postprocess import ClsPostProcess
...
class TextClassifier(object):
    def __init__(self, label_list=('0', '180'), cls_batch_num=6, cls_thresh=0.9, ort_providers=None):
        ...
        sess = ort.InferenceSession(Util.app_path() + f"/models/zzsfp/{model_file}", providers=ort_providers)
